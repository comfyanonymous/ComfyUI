...
parser.add_argument("--enable-prometheus", action="store_true", help="Enable the local Prometheus metrics endpoint.")
parser.add_argument("--prometheus-port", type=int, default=None, help="Run Prometheus metrics on this separate local port.")
