...
parser.add_argument("--preview-full-batch", action="store_true", help="Preview the entire batch as a tiled grid of per-item previews. When not set (default), only the first batch member is previewed.")
