...
parser.add_argument("--enable-model-readahead", action="store_true", help="Enable Windows read-ahead for large model files. Can reduce model load times on slower storage by using the OS file cache.")
