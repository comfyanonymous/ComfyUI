...
<<<<<<<< HEAD:comfy/web/assets/GraphView-DRxVGgSM.js
import { d as defineComponent, u as useSettingStore, r as ref, a as useTitleEditorStore, b as useCanvasStore, w as watch, L as LGraphGroup, c as app, e as LGraphNode, o as onMounted, f as onUnmounted, g as openBlock, h as createElementBlock, i as createVNode, E as EditableText, n as normalizeStyle, j as createCommentVNode, k as LiteGraph, _ as _export_sfc, B as BaseStyle, s as script$g, l as resolveComponent, m as mergeProps, p as renderSlot, q as computed, t as resolveDirective, v as withDirectives, x as createBlock, y as withCtx, z as unref, A as createBaseVNode, C as normalizeClass, D as script$h, F as useCommandStore, G as useDialogStore, S as SettingDialogHeader, H as SettingDialogContent, I as onBeforeUnmount, J as resolveDynamicComponent, K as useWorkspaceStore, M as useKeybindingStore, N as Fragment, O as renderList, T as Teleport, P as script$i, Q as getWidth, R as findSingle, U as getOuterHeight, V as getOffset, W as getOuterWidth, X as getHeight, Y as script$j, Z as script$k, $ as Ripple, a0 as getAttribute, a1 as focus, a2 as equals, a3 as useBottomPanelStore, a4 as toDisplayString, a5 as script$l, a6 as getVNodeProp, a7 as isArray, a8 as useSidebarTabStore, a9 as vShow, aa as isNotEmpty, ab as script$m, ac as UniqueComponentId, ad as ZIndex, ae as resolveFieldData, af as OverlayEventBus, ag as isEmpty, ah as addStyle, ai as relativePosition, aj as absolutePosition, ak as ConnectedOverlayScrollHandler, al as isTouchDevice, am as findLastIndex, an as script$n, ao as script$o, ap as script$p, aq as script$q, ar as script$r, as as script$s, at as Transition, au as createSlots, av as createTextVNode, aw as useNodeFrequencyStore, ax as useNodeBookmarkStore, ay as highlightQuery, az as script$t, aA as formatNumberWithSuffix, aB as NodeSourceType, aC as useI18n, aD as useNodeDefStore, aE as NodePreview, aF as NodeSearchFilter, aG as script$u, aH as SearchFilterChip, aI as watchEffect, aJ as toRaw, aK as LinkReleaseTriggerAction, aL as useEventListener, aM as nextTick, aN as getColorPalette, aO as BadgePosition, aP as LGraphBadge, aQ as _, aR as defaultColorPalette, aS as NodeBadgeMode, aT as markRaw, aU as useModelToNodeStore, aV as CanvasPointer, aW as useWorkflowStore, aX as setStorageValue, aY as api, aZ as usePragmaticDroppable, a_ as ComfyNodeDefImpl, a$ as ComfyModelDef, b0 as LGraph, b1 as LLink, b2 as DragAndScale, b3 as LGraphCanvas, b4 as ContextMenu, b5 as ChangeTracker, b6 as script$v, b7 as script$w, b8 as script$x, b9 as script$y, ba as normalizeProps, bb as ToastEventBus, bc as setAttribute, bd as TransitionGroup, be as useToast, bf as useToastStore, bg as useExecutionStore, bh as useTitle, bi as withModifiers, bj as script$z, bk as workflowService, bl as resolve, bm as script$A, bn as script$B, bo as isPrintableCharacter, bp as guardReactiveProps, bq as useMenuItemStore, br as script$E, bs as nestedPosition, bt as useQueueSettingsStore, bu as storeToRefs, bv as isRef, bw as script$F, bx as useQueuePendingTaskCountStore, by as useLocalStorage, bz as useDraggable, bA as watchDebounced, bB as inject, bC as useElementBounding, bD as lodashExports, bE as useEventBus, bF as provide, bG as script$G, bH as i18n, bI as useModelStore } from "./index-bi78Y1IN.js";
import { s as script$C, a as script$D } from "./index-bCeMLtLM.js";
========
...
>>>>>>>> 0fd4e6c7787daa922cb0d9bd1241b276b39ce2c5:comfy/web/assets/GraphView-BW5soyxY.js
...
<<<<<<<< HEAD:comfy/web/assets/GraphView-DRxVGgSM.js
      if (app.graph?.config) {
        app.graph.config.alwaysSnapToGrid = settingStore.get("pysssss.SnapToGrid");
      }
========
...
<<<<<<<< HEAD:comfy/web/assets/GraphView-DRxVGgSM.js
          createBaseVNode("div", _hoisted_2$4, [
            !unref(workspaceStore).shiftDown && option2.workflow.isModified ? (openBlock(), createElementBlock("span", _hoisted_3$3, "•")) : createCommentVNode("", true),
            createVNode(unref(script$h), {
========
...
<<<<<<<< HEAD:comfy/web/assets/GraphView-DRxVGgSM.js
//# sourceMappingURL=GraphView-DRxVGgSM.js.map
========
