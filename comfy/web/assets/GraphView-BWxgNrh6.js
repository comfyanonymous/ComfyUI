...
<<<<<<<< HEAD:comfy/web/assets/GraphView-BAZmiysO.js
import { d as defineStore, s as shallowRef, a as defineComponent, u as useSettingStore, r as ref, w as watch, L as LGraphGroup, b as app, c as LGraphNode, o as onMounted, e as onUnmounted, f as openBlock, g as createElementBlock, h as createVNode, E as EditableText, n as normalizeStyle, i as createCommentVNode, j as LiteGraph, _ as _export_sfc, B as BaseStyle, k as script$g, l as resolveComponent, m as mergeProps, p as renderSlot, q as computed, t as resolveDirective, v as withDirectives, x as createBlock, y as withCtx, z as unref, A as createBaseVNode, C as normalizeClass, D as script$h, F as useCommandStore, G as useDialogStore, S as SettingDialogHeader, H as SettingDialogContent, I as useI18n, J as useUserStore, K as onBeforeUnmount, M as resolveDynamicComponent, N as useWorkspaceStore, O as useKeybindingStore, P as Fragment, Q as renderList, T as Teleport, R as script$i, U as getWidth, V as findSingle, W as getOuterHeight, X as getOffset, Y as getOuterWidth, Z as getHeight, $ as script$j, a0 as script$k, a1 as Ripple, a2 as getAttribute, a3 as focus, a4 as equals, a5 as useBottomPanelStore, a6 as toDisplayString, a7 as script$l, a8 as getVNodeProp, a9 as isArray, aa as useSidebarTabStore, ab as vShow, ac as isNotEmpty, ad as script$m, ae as UniqueComponentId, af as ZIndex, ag as resolveFieldData, ah as OverlayEventBus, ai as isEmpty, aj as addStyle, ak as relativePosition, al as absolutePosition, am as ConnectedOverlayScrollHandler, an as isTouchDevice, ao as findLastIndex, ap as script$n, aq as script$o, ar as script$p, as as script$q, at as script$r, au as script$s, av as Transition, aw as createSlots, ax as createTextVNode, ay as useNodeFrequencyStore, az as useNodeBookmarkStore, aA as highlightQuery, aB as script$t, aC as formatNumberWithSuffix, aD as NodeSourceType, aE as useNodeDefStore, aF as NodePreview, aG as NodeSearchFilter, aH as script$u, aI as SearchFilterChip, aJ as storeToRefs, aK as watchEffect, aL as useEventListener, aM as isRef, aN as toRaw, aO as LinkReleaseTriggerAction, aP as nextTick, aQ as getColorPalette, aR as BadgePosition, aS as LGraphBadge, aT as _, aU as defaultColorPalette, aV as NodeBadgeMode, aW as markRaw, aX as useModelToNodeStore, aY as CanvasPointer, aZ as useWorkflowStore, a_ as setStorageValue, a$ as api, b0 as usePragmaticDroppable, b1 as ComfyNodeDefImpl, b2 as ComfyModelDef, b3 as LGraph, b4 as LLink, b5 as DragAndScale, b6 as LGraphCanvas, b7 as ContextMenu, b8 as ChangeTracker, b9 as workflowService, ba as script$v, bb as script$w, bc as script$x, bd as script$y, be as normalizeProps, bf as ToastEventBus, bg as setAttribute, bh as TransitionGroup, bi as useToast, bj as useToastStore, bk as useExecutionStore, bl as useTitle, bm as withModifiers, bn as script$z, bo as script$A, bp as resolve, bq as script$B, br as script$C, bs as isPrintableCharacter, bt as guardReactiveProps, bu as useMenuItemStore, bv as normalizeI18nKey, bw as script$F, bx as nestedPosition, by as useQueueSettingsStore, bz as script$G, bA as useQueuePendingTaskCountStore, bB as useLocalStorage, bC as useDraggable, bD as watchDebounced, bE as inject, bF as useElementBounding, bG as lodashExports, bH as useEventBus, bI as provide, bJ as script$H, bK as LGraphEventMode, bL as useQueueStore, bM as showTemplateWorkflowsDialog, bN as showSettingsDialog, bO as i18n, bP as useModelStore } from "./index-BQYg0VNJ.js";
import { s as script$D, a as script$E } from "./index-DJqEjTnE.js";
...
>>>>>>>> 57f330caf91af37dda67c4202bb27cdebb7161d8:comfy/web/assets/GraphView-BWxgNrh6.js
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createBlock(unref(script$h), {
        ...
        icon: withCtx(() => [
          shouldShowBadge.value ? (openBlock(), createBlock(unref(script$f), {
            key: 0,
...
var script$e = {
  ...
  methods: {
    ...
    updateDirection: /* @__PURE__ */ __name(function updateDirection() {
      this.isRTL = !!this.$el.closest('[dir="rtl"]');
    }, "updateDirection"),
    observeDirectionChanges: /* @__PURE__ */ __name(function observeDirectionChanges() {
      var _this3 = this;
...
var _hoisted_3$8 = ["aria-label", "tabindex"];
function render$k(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    role: "presentation",
    "aria-hidden": "true"
  }, _ctx.ptm("activeBar")), null, 16)], 16, _hoisted_2$a)], 16), $options.showNavigators && $data.isNextButtonEnabled ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
    key: 1,
    ref: "nextButton",
    ...
    "aria-hidden": "true"
  }, _ctx.ptm("nextIcon")), null, 16))], 16, _hoisted_3$8)), [[_directive_ripple]]) : createCommentVNode("", true)], 16);
}
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$l, [
        createVNode(unref(script$l), {
          ...
          default: withCtx(() => [
            createVNode(unref(script$e), { "pt:tabList": "border-none" }, {
              default: withCtx(() => [
...
var script$c = {
  ...
  methods: {
    updateDirection: /* @__PURE__ */ __name(function updateDirection2() {
      this.isRTL = !!this.$el.closest('[dir="rtl"]');
    }, "updateDirection"),
    observeDirectionChanges: /* @__PURE__ */ __name(function observeDirectionChanges2() {
      var _this = this;
      var targetNode = document.documentElement;
      var config = {
        attributes: true,
    ...
    bindTouchListeners: /* @__PURE__ */ __name(function bindTouchListeners() {
      ...
      if (!this.touchMoveListener) {
        this.touchMoveListener = function(event) {
          return _this5.onResize(event.changedTouches[0]);
        };
        document.addEventListener("touchmove", this.touchMoveListener);
      }
      if (!this.touchEndListener) {
        this.touchEndListener = function(event) {
          _this5.resizeEnd(event);
          _this5.unbindTouchListeners();
        };
    ...
    restoreState: /* @__PURE__ */ __name(function restoreState() {
      ...
      if (stateString) {
        ...
        children.forEach(function(child, i) {
          child.style.flexBasis = "calc(" + _this6.panelSizes[i] + "% - " + (_this6.panels.length - 1) * _this6.gutterSize + "px)";
        });
        return true;
      }
      return false;
  ...
  computed: {
    panels: /* @__PURE__ */ __name(function panels() {
      ...
      this.$slots["default"]().forEach(function(child) {
        if (_this7.isSplitterPanel(child)) {
          panels2.push(child);
        } else if (child.children instanceof Array) {
          child.children.forEach(function(nestedChild) {
            if (_this7.isSplitterPanel(nestedChild)) {
...
var script$a = {
  ...
  methods: {
    ...
    removeOption: /* @__PURE__ */ __name(function removeOption(event, index) {
      ...
      var value = this.d_value.filter(function(_2, i) {
        return i !== index;
...
<<<<<<<< HEAD:comfy/web/assets/GraphView-BAZmiysO.js
const NodeTooltip = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-259081e0"]]);
========
...
const _hoisted_2$4 = { class: "workflow-label text-sm max-w-[150px] truncate inline-block" };
...
<<<<<<<< HEAD:comfy/web/assets/GraphView-BAZmiysO.js
const WorkflowTabs = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-012040ee"]]);
========
...
var _hoisted_1$a = ["id"];
var _hoisted_2$1 = ["id", "aria-labelledby"];
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "default": withCtx(function() {
      ...
      }, _ctx.ptm("footer")), [renderSlot(_ctx.$slots, "footer")], 16)) : createCommentVNode("", true)], 16, _hoisted_2$1), [[vShow, !$data.d_collapsed]])];
    }),
    _: 3
  }, 16)], 16);
}
...
<<<<<<<< HEAD:comfy/web/assets/GraphView-BAZmiysO.js
const TopMenubar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-51020bc7"]]);
========
...
<<<<<<<< HEAD:comfy/web/assets/GraphView-BAZmiysO.js
//# sourceMappingURL=GraphView-BAZmiysO.js.map
========
