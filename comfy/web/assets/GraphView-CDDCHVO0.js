  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(script$e), {
        ...
        default: withCtx(() => [
          sidebarLocation.value === "left" ? withDirectives((openBlock(), createBlock(unref(script$d), {
            key: 0,
          ...
          createVNode(unref(script$d), { size: 100 }, {
            default: withCtx(() => [
              createVNode(unref(script$e), {
                ...
                default: withCtx(() => [
                  createVNode(unref(script$d), { class: "graph-canvas-panel relative" }, {
                    default: withCtx(() => [
                      renderSlot(_ctx.$slots, "graph-canvas-panel", {}, void 0, true)
                    ]),
                    _: 3
                  }),
                  withDirectives(createVNode(unref(script$d), { class: "bottom-panel" }, {
                    default: withCtx(() => [
          ...
          sidebarLocation.value === "right" ? withDirectives((openBlock(), createBlock(unref(script$d), {
            key: 1,
            class: "side-bar-panel",
            minSize: 10,
            size: 20
...
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _directive_tooltip = resolveDirective("tooltip");
      return openBlock(), createBlock(unref(script$a), { class: "p-buttongroup-vertical absolute bottom-[10px] right-[10px] z-[1000] pointer-events-auto" }, {
        default: withCtx(() => [
          withDirectives(createVNode(unref(script$f), {
            severity: "secondary",
            icon: "pi pi-plus",
...
>>>>>>>> 13fd4d6e45128f3aed95ee66151353e84daf2d13:comfy/web/assets/GraphView-CDDCHVO0.js
            ...
            showIdName.value ? (openBlock(), createBlock(unref(script$r), {
              key: 1,
              severity: "secondary"
            }, {
              default: withCtx(() => [
        ...
        createBaseVNode("div", _hoisted_7, [
          _ctx.nodeDef.experimental ? (openBlock(), createBlock(unref(script$r), {
            key: 0,
            value: _ctx.$t("g.experimental"),
            severity: "primary"
          }, null, 8, ["value"])) : createCommentVNode("", true),
          _ctx.nodeDef.deprecated ? (openBlock(), createBlock(unref(script$r), {
            key: 1,
            value: _ctx.$t("g.deprecated"),
            severity: "danger"
          }, null, 8, ["value"])) : createCommentVNode("", true),
          showNodeFrequency.value && nodeFrequency.value > 0 ? (openBlock(), createBlock(unref(script$r), {
            key: 2,
            value: unref(formatNumberWithSuffix)(nodeFrequency.value, { roundToInt: true }),
            severity: "secondary"
          }, null, 8, ["value"])) : createCommentVNode("", true),
          _ctx.nodeDef.nodeSource.type !== unref(NodeSourceType).Unknown ? (openBlock(), createBlock(unref(script$q), {
            key: 3,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createBlock(unref(script$f), {
        ...
        icon: withCtx(() => [
          shouldShowBadge.value ? (openBlock(), createBlock(unref(script$8), {
            key: 0,
...
>>>>>>>> 13fd4d6e45128f3aed95ee66151353e84daf2d13:comfy/web/assets/GraphView-CDDCHVO0.js
      ...
      }), 128))], 8, _hoisted_1$1$2)) : createCommentVNode("", true)];
    }),
    _: 1
  }, 16, ["onEnter"]);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        createVNode(unref(script$a), { class: "execution-actions flex flex-nowrap" }, {
          default: withCtx(() => [
            withDirectives(createVNode(unref(script$f), {
              icon: "pi pi-times",
