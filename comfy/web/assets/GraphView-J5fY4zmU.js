  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(script$8), {
        ...
        default: withCtx(() => [
          nodeSelected.value || groupSelected.value ? (openBlock(), createBlock(ColorPickerButton, { key: 0 })) : createCommentVNode("", true),
          ...
          nodeSelected.value || groupSelected.value ? (openBlock(), createBlock(unref(script), {
            key: 2,
            severity: "secondary",
            text: "",
...
const SelectionToolbox = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-5f2fc3fa"]]);
...
//# sourceMappingURL=GraphView-J5fY4zmU.js.map
