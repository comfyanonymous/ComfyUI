...
>>>>>>>> 31831e6ef13474b975eee1a94f39078e00b00156:comfy/web/assets/InstallView-CAcYt0HL.js
var classes$4 = {
...
const _hoisted_10$3 = { class: "text-neutral-200" };
const _hoisted_11$3 = { class: "pi pi-info-circle" };
const _hoisted_12$3 = { class: "flex items-center gap-2" };
        ...
        createBaseVNode("div", _hoisted_6$3, [
          ...
          createBaseVNode("div", _hoisted_8$3, [
            createBaseVNode("div", _hoisted_9$3, [
              ...
              createBaseVNode("span", _hoisted_10$3, toDisplayString(appData.value), 1),
              withDirectives(createBaseVNode("span", _hoisted_11$3, null, 512), [
...
const _hoisted_8 = { class: "m-1" };
const _hoisted_9 = { key: 3 };
const _hoisted_10 = { class: "m-1" };
const _hoisted_11 = { class: "m-1" };
const _hoisted_12 = {
  for: "cpu-mode",
  class: "select-none"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          selected.value === "nvidia" ? (openBlock(), createElementBlock("p", _hoisted_5$1, [
          ...
          selected.value === "mps" ? (openBlock(), createElementBlock("p", _hoisted_6, [
            createVNode(unref(script$h), {
              icon: "pi pi-check",
              severity: "success",
              value: "MPS"
          ...
          selected.value === "unsupported" ? (openBlock(), createElementBlock("div", _hoisted_7, [
          ...
          selected.value === "cpu" ? (openBlock(), createElementBlock("div", _hoisted_9, [
            ...
            createBaseVNode("p", _hoisted_11, toDisplayString(_ctx.$t("install.gpuSelection.cpuModeDescription2")), 1)
          ])) : createCommentVNode("", true)
        ]),
        createBaseVNode("div", {
          class: normalizeClass(["transition-opacity flex gap-3 h-0", {
          ...
          createBaseVNode("label", _hoisted_12, toDisplayString(_ctx.$t("install.gpuSelection.enableCpuMode")), 1)
        ], 2)
      ]);
    };
  }
...
//# sourceMappingURL=InstallView-DiTLLUby.js.map
========
