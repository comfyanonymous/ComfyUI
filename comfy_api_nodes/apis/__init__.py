...
#   timestamp: 2025-05-01T00:26:01+00:00
...
class Member(BaseModel):
    color: Optional[constr(pattern=r'^#[0-9A-Fa-f]{6}$')] = Field(
        None, description='Hexadecimal color code'
    )
    weight: Optional[confloat(ge=0.0, le=1.0)] = Field(
...
class IdeogramV3EditRequest(BaseModel):
    ...
    style_codes: Optional[List[constr(pattern=r'^[0-9A-Fa-f]{8}$')]] = Field(
        None,
...
class IdeogramV3Request(BaseModel):
    ...
    num_images: Optional[conint(ge=1)] = Field(
