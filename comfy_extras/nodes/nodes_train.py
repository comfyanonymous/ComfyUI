...
class TrainSampler(comfy.samplers.Sampler):
    ...
    def sample(self, model_wrap, sigmas, extra_args, callback, noise, latent_image=None, denoise_mask=None, disable_pbar=False):
        ...
        for i in (pbar:=tqdm.trange(self.total_steps, desc="Training LoRA", smoothing=0.01, disable=not current_execution_context().server.receive_all_progress_notifications)):
            noisegen = Noise_RandomNoise(self.seed + i * 1000)
