...
class CLIPTextEncodeSDXLRefiner:
    ...
    @classmethod
    def VALIDATE_INPUTS(s, clip, ascore, width, height, text):
...
class CLIPTextEncodeSDXL:
    ...
    def IS_CHANGED(cls, clip, width, height, crop_w, crop_h, target_width, target_height, text_g, text_l):
        ...
        if math.isnan(text_g_changed) or math.isnan(text_l_changed):
            # Log to console
            print("CLIPTextEncodeSDXL.IS_CHANGED: NaN")
            return float("nan")
        else:
            # Log to console
            print("CLIPTextEncodeSDXL.IS_CHANGED: %s" % (text_g_changed + text_l_changed))
