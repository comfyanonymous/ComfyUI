...
class StartLoop(io.ComfyNode):
    ...
    def define_schema(cls):
        ...
        return io.Schema(
                ...
                io.DynamicCombo.Input("mode", options=[
                    ...
                    io.DynamicCombo.Option("For", [
                        io.Int.Input(
                            "start_iteration",
                            default=0,
                            tooltip="The first iteration_index generated by For mode.",
                        ),
                        io.Int.Input(
                            "max_iteration",
                            default=4,
                        ...
                        io.Int.Input(
                            "step",
                            default=1,
                            tooltip="The amount added to iteration_index after each iteration in For mode. Must not be zero.",
                        ),
                    ]),
                    io.DynamicCombo.Option("List", [
                        io.MatchType.Input(
                            "list",
                            list_item_type,
                            tooltip="List whose items drive the loop. The body executes once per item.",
                        ),
                    ]),
                ], tooltip="Select how the loop's iteration values are generated."),
                io.Int.Input(
                    "iteration_outer",
                    optional=True,
                    force_input=True,
                    tooltip="Connect iteration_index from an outer Start Loop to nest this loop and enforce iteration ordering.",
                ),
                io.MatchType.Input(
            ...
            outputs=[
                io.Int.Output("iteration_index", tooltip="The integer index of this iteration."),
                io.Boolean.Output("is_first", tooltip="True during the first iteration of the loop."),
                io.Boolean.Output("is_last", tooltip="True during the final iteration of the loop."),
                io.MatchType.Output(
                    list_item_type,
                    id="list_item",
                    tooltip="Current list item in List mode. None in simple and For modes.",
                ),
                io.MatchType.Output(
                    carried_type,
    ...
    @classmethod
    def execute(cls, mode, iteration_outer=None, initial_iteration_value=None):
        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.MatchType.Input(
                    ...
                    carried_type,
                    optional=True,
                    tooltip="Value carried from End Loop back to Start Loop as current_iteration_value on the next iteration.",
                ),
                io.Boolean.Input(
                    "accumulate",
                    default=False,
                ...
                io.Autogrow.Input(
                    ...
                    optional=True,
                    tooltip="Add preview or side-effect outputs that End Loop must execute on every iteration. Their values are not returned.",
                ),
            ],
            outputs=[
                io.MatchType.Output(
