...
## Info
- **File:** `Ukraine.safetensors`
- **Civitai:** https://civitai.com/models/2113216/watw-ukraine
- **Trigger:** `Ukraine` or `Ukraine woman`
- **Strength:** 1.0
