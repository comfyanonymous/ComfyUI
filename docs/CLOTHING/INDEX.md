...
This directory contains individual documentation for all CLOTHING category LoRAs. Each LoRA has been extracted from the main documentation file and organized into separate, easy-to-reference markdown files.

---

## Quality Stats - Sorted by Downloads
...
- ⭐⭐ = >1,000 downloads (High Quality)
- ⭐ = >500 downloads (Good Quality)
- < 500 = Emerging/Niche

---

## Top Picks by Quality Metrics

### Highest Download Count (Most Popular)
1. **FLUX Skirt Lift** - 4,111 downloads
2. **See Through Clothing** - 3,467 downloads
3. **Sheer Clothes Pull Down** - 3,205 downloads

### Highest Tips (Most Appreciated)
1. **Panties in Pussy** - $20,040
2. **Pleaser Shoes** - $17,978
3. **Woman with Panties Down** - $3,939

### Best Rating
1. **See Through Clothing** - 311 rating
2. **FLUX Skirt Lift** - 239 rating
3. **Sheer Clothes Pull Down** - 222 rating

### Best Value (High Downloads + High Tips)
1. **FLUX Skirt Lift** - 4,111 downloads, $342 tips
2. **Woman with Panties Down** - 1,892 downloads, $3,939 tips
3. **Upskirt Panties** - 1,877 downloads, $3,353 tips
...
- [PantyBetweenLegs](pantybetweenlegs.md) - ⭐⭐ Panties lowered between legs
- [Upskirt Panties](upskirt_panties.md) - ⭐⭐ Upskirt with visible panties
...
### Pantyhose / Stockings / Hosiery
- [Flux Black Pantyhose](flux_black_pantyhose.md) - ⭐⭐ Realistic black sheer pantyhose
- [Flux Seamless Pantyhose](flux_seamless_pantyhose.md) - ⭐⭐ Crotchless seamless pantyhose
- [Flux Pantyhose Feet](flux_pantyhose_feet.md) - ⭐⭐ Nylon feet and soles focus
- [Nude in Garters Stockings](nude_in_garters_stockings.md) - ⭐⭐ Black fully fashioned vintage stockings
- [Garterbelt Flux](garterbelt_flux.md) - ⭐⭐ Garter belts with stockings
- [RealTanFFStockings](realtanffstockings.md) - ⭐ Vintage tan back seam stockings
- [Women in Pantyhose](women_in_pantyhose.md) - Various poses, 500+ images trained

### Dresses
- [Sequin Dress](sequin_dress.md) - Metallic sequin dresses with mirrorball effect
- [Longsleeve Bandage Dress](longsleeve_bandage_dress.md) - Form-fitting bandage dress
- [One Shoulder Bandage Dress](one_shoulder_bandage_dress.md) - Asymmetric bandage dress
...
### Pants / Jeans
- [Blue Jeans Down](blue_jeans_down.md) - ⭐ Jeans stripped down exposure
...
| LoRA | Trigger Word(s) |
|------|----------------|
| FLUX Skirt Lift | `skirt lift`, `pussy visible` |
| See Through Clothing | `aidmaseethrough` |
| Sheer Clothes Pull Down | None (use keywords) |
| Flux Black Pantyhose | No trigger (describe in prompt) |
...
| Flux Pantyhose Feet | `nylon feet`, `nylon soles`, `soles` |
| Women in Pantyhose | `pantyhose` |
| Garterbelt Flux | `gartbt` |
| PantyBetweenLegs | None (use keywords) |
...
| Racequeens | `racequeen costume` |
| Patent Leather Pants | `piku001` |
...
### For Panty/Underwear Effects
- Combine panty LoRAs with anatomy LoRAs for better detail
- Use NSFW unlocking LoRAs (MysticXXX) for explicit content
- Lower CFG (1-4) works well for FLUX panty LoRAs

### For Stockings/Pantyhose
- Black pantyhose works best with full body shots
- Garter LoRAs benefit from view angle specifications (front/back/side)
- Lower strength (0.7-0.9) when combining multiple hosiery LoRAs

### For Clothing Effects
- See-through/sheer effects work at 0.7-1.0 strength
- Use "revealing" and "exposing" keywords for stronger effects
- Avoid word "wearing" with sheer clothes - use action verbs

### For Footwear
- Specify platform height for Pleaser shoes ("10inch platform base")
- Use realism LoRAs to avoid plastic look on heels
- Slingbacks need accurate prompting

---

## Workflow Recommendations

### High-Quality Realistic Look
```
Base Checkpoint: FLUX Dev
+ <lora:flux_realism_lora:0.7>
+ <lora:Flux_Skin_Detailer:0.8>
+ Clothing LoRA of choice
```

### NSFW/Explicit Content
```
Base Checkpoint: FLUX Dev or Acorn NSFW
+ <lora:MysticXXX-v7:0.6>
+ Panty/Underwear LoRA
+ <lora:pussydiffusion-f1:0.3> (for anatomy)
```
...
- `flux_skirt_lift.md`
- `see_through_clothing.md`
- `woman_with_panties_down.md`
- etc.
