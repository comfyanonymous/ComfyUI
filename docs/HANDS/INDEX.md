...
| [Hands XL (Hand v2)](hands_xl_v2.md) | Hand v2.safetensors | - | - | - | ⭐ |
| [Feminine Hands](feminine_hands.md) | feminine_hands.safetensors | 217 | 8 | 1,198 | - |
| [Nelli's Nails](nellis_nails.md) | Nellis_Nails.safetensors | - | - | - | - |
...
### Hand Anatomy Fix
- [Hands XL (Hand v2)](hands_xl_v2.md) - Multi-model compatible, reduces extra fingers
- [FluxHands Final Bonus](fluxhands_final_bonus.md) - FLUX-specific hand fix
...
### Nails & Manicure
- [Nelli's Nails](nellis_nails.md) - Long fingernails with various styles and colors

### Feminine Hands
- [Feminine Hands](feminine_hands.md) - Slender, delicate feminine hands

## Quick Reference - Triggers

| LoRA | Trigger Word | Required |
|------|--------------|----------|
