import torch
from mock_comfy.ldm.modules.diffusionmodules.openaimodel import UNetModel
from mock_comfy.ldm.modules.encoders.noise_aug_modules import CLIPEmbeddingNoiseAugmentation
from mock_comfy.ldm.modules.diffusionmodules.util import make_beta_schedule
from mock_comfy.ldm.modules.diffusionmodules.openaimodel import Timestep
...
class BaseModel(torch.nn.Module):
    ...
    def extra_conds(self, **kwargs):
        ...
        if self.inpaint_model:
            ...
            out['c_concat'] = mock_comfy.conds.CONDNoiseShape(data)
        adm = self.encode_adm(**kwargs)
        if adm is not None:
            out['y'] = mock_comfy.conds.CONDRegular(adm)
        return out
    ...
    def state_dict_for_saving(self, clip_state_dict, vae_state_dict):
        ...
        unet_state_dict = {}
        for k in unet_sd:
            unet_state_dict[k] = mock_comfy.model_management.resolve_lowvram_weight(unet_sd[k], self.diffusion_model, k)
