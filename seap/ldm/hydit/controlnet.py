...
from seap.ldm.modules.diffusionmodules.mmdit import (
    Mlp,
    TimestepEmbedder,
    PatchEmbed,
    RMSNorm,
)
from seap.ldm.modules.diffusionmodules.util import timestep_embedding
...
class HunYuanControlNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.norm = norm
        self.dtype = dtype
        self.latent_format = seap.latent_formats.SDXL
    ...
    def forward(
        ...
        **kwarg,
        ...
        padding = seap.ops.cast_to_input(self.text_embedding_padding, text_states)
