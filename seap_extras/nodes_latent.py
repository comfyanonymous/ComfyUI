...
def reshape_latent_to(target_shape, latent):
    if latent.shape[1:] != target_shape[1:]:
        latent = seap.utils.common_upscale(latent, target_shape[3], target_shape[2], "bilinear", "center")
    return seap.utils.repeat_to_batch_size(latent, target_shape[0])
...
class LatentBatch:
    ...
    def batch(self, samples1, samples2):
        ...
        if s1.shape[1:] != s2.shape[1:]:
            s2 = seap.utils.common_upscale(s2, s1.shape[3], s1.shape[2], "bilinear", "center")
