...
class LCM(seap.model_sampling.EPS):
...
class X0(seap.model_sampling.EPS):
    def calculate_denoised(self, sigma, model_output, model_input):
        return model_output

class ModelSamplingDiscreteDistilled(seap.model_sampling.ModelSamplingDiscrete):
...
class ModelSamplingDiscrete:
    ...
    def patch(self, model, sampling, zsnr):
        ...
        sampling_base = seap.model_sampling.ModelSamplingDiscrete
        if sampling == "eps":
            sampling_type = seap.model_sampling.EPS
        elif sampling == "v_prediction":
            sampling_type = seap.model_sampling.V_PREDICTION
        elif sampling == "lcm":
            sampling_type = LCM
...
class ModelSamplingStableCascade:
    ...
    def patch(self, model, shift):
        ...
        sampling_base = seap.model_sampling.StableCascadeSampling
        sampling_type = seap.model_sampling.EPS
...
class ModelSamplingSD3:
    ...
    def patch(self, model, shift, multiplier=1000):
        ...
        sampling_base = seap.model_sampling.ModelSamplingDiscreteFlow
        sampling_type = seap.model_sampling.CONST
...
class ModelSamplingFlux:
    ...
    def patch(self, model, max_shift, base_shift, width, height):
        ...
        sampling_base = seap.model_sampling.ModelSamplingFlux
        sampling_type = seap.model_sampling.CONST
...
class ModelSamplingContinuousEDM:
    ...
    def patch(self, model, sampling, sigma_max, sigma_min):
        ...
        if sampling == "eps":
            ...
            sampling_type = seap.model_sampling.EDM
            sigma_data = 0.5
            latent_format = seap.latent_formats.SDXL_Playground_2_5()

        class ModelSamplingAdvanced(seap.model_sampling.ModelSamplingContinuousEDM, sampling_type):
            pass
...
class ModelSamplingContinuousV:
    ...
    def patch(self, model, sampling, sigma_max, sigma_min):
        ...
        class ModelSamplingAdvanced(seap.model_sampling.ModelSamplingContinuousV, sampling_type):
            pass
