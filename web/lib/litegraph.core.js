...
var Y = /* @__PURE__ */ ((e) => (e[e.INPUT = 0] = "INPUT", e[e.OUTPUT = 1] = "OUTPUT", e))(Y || {}), de = /* @__PURE__ */ ((e) => (e[e.STRAIGHT_LINK = 0] = "STRAIGHT_LINK", e[e.LINEAR_LINK = 1] = "LINEAR_LINK", e[e.SPLINE_LINK = 2] = "SPLINE_LINK", e))(de || {});
      ...
      if (b)
        for (var h = 0, p = this.graph._nodes.length; h < p; ++h) {
          ...
          if (m.mouseOver && l != m) {
            ...
            this.node_over = null, this.dirty_canvas = !0, E != this.node_over && this.onHoverChange && this.onHoverChange(this.node_over, E);
          }
        }
      if (l) {
        if (l.redraw_on_mouse && (this.dirty_canvas = !0), b) {
          if (!l.mouseOver) {
            ...
            this.node_over = l, this.dirty_canvas = !0, m != this.node_over && this.onHoverChange && this.onHoverChange(this.node_over, m), l.onMouseEnter && l.onMouseEnter(i, [i.canvasX - l.pos[0], i.canvasY - l.pos[1]], this);
          }
  ...
  configure(e) {
    ...
    if (n != null && (this.bgcolor || (this.bgcolor = n)), this.inputs)
      for (let o = 0; o < this.inputs.length; ++o) {
        ...
        a.properties || (a.properties = {}), this.onConnectionsChange && this.onConnectionsChange(Y.INPUT, o, !0, l, a), this.onInputAdded && this.onInputAdded(a);
      }
    if (this.outputs)
      for (var s = 0; s < this.outputs.length; ++s) {
        ...
        if (o.properties || (o.properties = {}), !!o.links) {
          for (let a = 0; a < o.links.length; ++a) {
            ...
            this.onConnectionsChange && this.onConnectionsChange(Y.OUTPUT, s, !0, l, o);
          }
  ...
  *iterateParentSubgraphNodes() {
  ...
  setInputSlotProperty(e, t, i) {
    if (!(!this.inputs || !this.graph) && !(e == -1 || e >= this.inputs.length)) {
      ...
      if (n && (n.properties || (n.properties = {}), i !== n.properties[t])) {
        ...
        n.properties[t] = i, this.graph && this.graph._version++, this.onSlotPropertyChanged && this.onSlotPropertyChanged(Y.INPUT, e, n, t, i, s) === !1 && (n.properties[t] = s);
      }
    }
  }
  setOutputSlotProperty(e, t, i) {
    if (!(!this.outputs || !this.graph) && !(e == -1 || e >= this.outputs.length)) {
      ...
      if (n && (n.properties || (n.properties = {}), i !== n.properties[t])) {
        var s = n.properties[t];
        n.properties[t] = i, this.graph && this.graph._version++, this.onSlotPropertyChanged && this.onSlotPropertyChanged(Y.OUTPUT, e, n, t, i, s) === !1 && (n.properties[t] = s);
      }
    }
  }
    ...
    if (n != null) {
      ...
      if (s) {
        ...
        delete this.graph.links[n], this.graph && this.graph._version++, this.onConnectionsChange && this.onConnectionsChange(
          ...
          r,
          a
        ), this.graph.onNodeConnectionChange(Y.INPUT, this, e));
      }
    }
    ...
    const b = (D) => {
      ...
      if (i.do_type_filter && !ee.skipFilter) {
        ...
        if (ee.inTypeOverride != null && (H = ee.inTypeOverride), V && H && u.registered_slot_in_types[H] && u.registered_slot_in_types[H].nodes) {
          var te = u.registered_slot_in_types[H].nodes.includes(W);
          if (te === !1)
            return !1;
        }
        if (H = R == null ? void 0 : R.value, ee.outTypeOverride != null && (H = ee.outTypeOverride), R && H && u.registered_slot_out_types[H] && u.registered_slot_out_types[H].nodes) {
          var te = u.registered_slot_out_types[H].nodes.includes(W);
          if (te === !1)
            return !1;
        }
      }
      ...
      if (s.onSearchBox) {
        ...
        let W, H;
        i.do_type_filter && s.search_box ? (W = s.search_box.querySelector(".slot_in_type_filter"), H = s.search_box.querySelector(".slot_out_type_filter")) : (W = null, H = null);
        for (const x in u.searchbox_extras) {
          ...
          if (!((!i.show_all_if_empty || D) && le.desc.toLowerCase().indexOf(D) === -1)) {
            ...
            if (!(be && be.filter != R) && E(le.type, R, D, W, H) && (te(le.desc, "searchbox_extra"), N.search_limit !== -1 && V++ > N.search_limit))
              break;
          }
        }
        var ee = null;
        if (Array.prototype.filter)
          var fe = Object.keys(u.registered_node_types), ee = fe.filter((q) => E(q, R, D, W, H));
        else {
          ee = [];
          for (const x in u.registered_node_types)
            E(x, R, D, W, H) && ee.push(x);
        }
        for (var F = 0; F < ee.length && (te(ee[F]), !(N.search_limit !== -1 && V++ > N.search_limit)); F++)
          ;
        if (i.show_general_after_typefiltered && (W != null && W.value || H != null && H.value)) {
          let x = [];
          for (const q in u.registered_node_types)
            E(q, R, D, W, H, { inTypeOverride: W && W.value ? "*" : null, outTypeOverride: H && H.value ? "*" : null }) && x.push(q);
          for (let q = 0; q < x.length && (te(x[q], "generic_type"), !(N.search_limit !== -1 && V++ > N.search_limit)); q++)
            ;
        }
        if ((W != null && W.value || H != null && H.value) && (g == null ? void 0 : g.childNodes.length) == 0 && i.show_general_if_none_on_typefilter) {
          let x = [];
          for (const q in u.registered_node_types)
            E(q, R, D, W, H, { skipFilter: !0 }) && x.push(q);
      ...
      function te(W, H) {
        ...
        d || (d = W), x.innerText = W, x.dataset.type = escape(W), x.className = "litegraph lite-search-item", H && (x.className += " " + H), x.addEventListener("click", function(q) {
...
<button>+</button>`, l = n.addHTML(a, "subgraph_property extra", !0);
  ...
  getLinkMenuOptions(t) {
    ...
    return this.graph.onGetLinkMenuOptions && (h = this.graph.onGetLinkMenuOptions(h, t)), i.getExtraLinkOptions && (h = i.getExtraLinkOptions(this, t, Y.OUTPUT, h)), n.getExtraLinkOptions && (h = n.getExtraLinkOptions(this, t, Y.INPUT, h)), h;
  }
  showLinkMenu(t, i) {
...
class X {
  ...
  constructor(t, i = {}, n) {
    ...
    function a(d) {
      var _ = parseInt(o.style.top);
      return o.style.top = (_ + d.deltaY * i.scroll_speed).toFixed() + "px", d.preventDefault(), !0;
    }
    ...
    for (let d = 0; d < t.length; d++) {
      let _ = t[d], y = "";
      _ === 0 ? y = "" : typeof _ == "string" ? y = _ : y = _.content, this.addItem(y, _, i);
    }
    ...
    var p = i.left || 0, f = i.top || 0;
    if (i.event) {
      if (p = i.event.clientX - 10, f = i.event.clientY - 10, i.title && (f -= 20), i.parentMenu) {
        var c = i.parentMenu.root.getBoundingClientRect();
        p = c.left + c.width;
      }
      var v = document.body.getBoundingClientRect(), g = o.getBoundingClientRect();
      v.height == 0 && console.error("document.body height is 0. That is dangerous, set html,body { height: 100%; }"), v.width && p > v.width - g.width - 10 && (p = v.width - g.width - 10), v.height && f > v.height - g.height - 10 && (f = v.height - g.height - 10);
    }
    o.style.left = p + "px", o.style.top = f + "px", i.scale && (o.style.transform = "scale(" + i.scale + ")");
  }
  addItem(t, i, n = {}) {
    var s = this, r = document.createElement("div");
    r.className = "litemenu-entry submenu";
    var o = !1;
    typeof i == "string" && (i = { content: i }), i === 0 ? r.classList.add("separator") : (r.innerHTML = i.title ? i.title : t, i.disabled && (o = !0, r.classList.add("disabled")), (i.submenu || i.has_submenu) && r.classList.add("has_submenu"), typeof i == "function" ? r.dataset.value = t : r.dataset.value = "" + this.values.length, i.className && (r.className += " " + i.className)), this.values.push(i), this.root.appendChild(r), o || r.addEventListener("click", h), n.autoopen && u.pointerListenerAdd(r, "enter", l);
    let a = this;
    function l(p) {
      var f = this.value;
